...
def parse_args():
    p = argparse.ArgumentParser(description="Inferência com DecisionTree")
    p.add_argument("--model_path", default="outputs/DecisionTree_pipeline.joblib")
    p.add_argument("--data_path", required=True)
    p.add_argument("--output_path", default="predictions_tree.csv")
    return p.parse_args()
